...
All comparisons score the same 690 purged validation windows (2021-04-06 through 2023-12-29). Report counts including empty states, single-state flags, ARI against the saved reference, reference occupancy, convergence and mean squared distance to the nearest medoid. ARI is agreement, not accuracy.
