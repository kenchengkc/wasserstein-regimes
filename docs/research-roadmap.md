...
| 5, next | Frozen-model scoring and experiment scale | Atomic resumable jobs, isolated fold/seed workers, bounded worker count and BLAS threads, job identity independent of report-only files, validation against frozen schema, measured process RSS |
