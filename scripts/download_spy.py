...
"""Acquire a new snapshot; never overwrite the frozen study input."""
import argparse
import hashlib
import json
...
def main():
    ...
    data=yf.download('SPY',start='1993-01-01',end='2026-09-01',interval='1d',
    ...
    metadata=dict(provider='Yahoo Finance via yfinance',yfinance_version=yf.__version__,symbol='SPY',
